...
export const Spinning = ({ setCongrats, setResult }) => {
  ...
  useEffect(() => {
    ...
    if (calc >= 0 && calc <= 29) {
      ...
      const dateUntil = `${futureDay}-${futureMonth}-${futureYear}`;
      setPrize({
        description: "6 months FREE + 6 months half price",
        number: 4,
        valued: 539.91,
        days: 180,
        date: dateUntil,
      ...
      const dateUntil = `${futureDay}-${futureMonth}-${futureYear}`;
      setPrize({
        description: "3 months FREE + 3 months half price",
        number: 6,
        valued: 269.96,
        days: 90,
        date: dateUntil,
  ...
  return (
    <div className="flex flex-col p-5 justify-center items-center w-full min-h-screen md:w-[55%]">
      <div
        id="internalDIV"
        className="flex flex-col  mx-5 my-4 pb-2 justify-center items-center bg-white rounded-lg shadow-md relative"
      >
        <p
          className="fontTitle my-4"
        ...
        >
          {" "}
          To See How Many Free Months Use Of The Software You Win To Go With
          Your <span className="font-bold text-[#ff0000]">100 FREE</span>{" "}
          Plastic Referral Marketing Cards{" "}
          <span className="italic" style={{ fontSize: "0.8rem" }}>
            [total value up to £653]
          </span>
        </p>

        <div
          id="DIVsoftwarecomponents"
          className="flex flex-col justify-center items-center w-[90%] rounded-lg shadow-lg pb-2 mb-3 bg-[#243D8F]"
        >
          <p
          ...
          <ul className="fontGeneral py-5">
            ...
            <li className=" flex justify-around items-center h-fit border-2 border-[#ffcf31] py-1">
              <div className="w-[95%] h-[100%] flex justify-center items-center">
                ...
                <p
                  className="fontGeneral w-[100%] text-white text-center"
                  style={{ textAlign: "start", padding: "0 0 0 0" }}
                >
                  Stock Control
                </p>
              ...
              <div className="w-[95%] h-[100%] flex justify-center items-center">
                ...
                <p
                  className="fontGeneral w-[100%] text-white"
                  style={{ textAlign: "start", padding: "0 0 0 0" }}
                >
                  Invoicing{" "}
                </p>
        ...
        >
          ...
          <div className="flex justify-center items-center my-7 px-2 transform scale-100">
            ...
            >
              ...
              <div class="containerDIV containerONE">
                <div className="text-center w-[42px] h-[115px]">
                  {" "}
                  3 Months <p className="inline w-fit pt-3">FREE</p>
                </div>
              </div>
              <div class="containerDIV containerTWO">
                <div className="text-center w-[42px] h-[115px]">
                  {" "}
                  3M FREE + 3M <p className="text-sm inline">1/2</p> price{" "}
                </div>
              </div>
              <div class="containerDIV containerTHREE">
                <div className="text-center w-[42px] h-[115px]">
                  6 Months <p className="inline w-fit pt-3">FREE</p>{" "}
                </div>
              </div>
              <div class="containerDIV containerFOUR">
                <div className="text-center w-[42px] h-[115px]">
                  6M FREE + 6M <p className="text-sm inline">1/2</p> price
                </div>
              </div>
              <div class="containerDIV containerFIVE">
                <div className="text-center w-[42px] h-[115px]">
                  9 Months <p className="inline w-fit pt-3">FREE</p>
                </div>
              </div>
              <div class="containerDIV containerSIX">
                <div className="text-center w-[42px] h-[115px]">
                  12 Months <p className="inline w-fit pt-4">FREE</p>
                </div>
              </div>
            </div>
            <span class="mid"></span>
