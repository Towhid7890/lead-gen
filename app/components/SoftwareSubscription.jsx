...
const SoftwareSubscription = () => {
  ...
  useEffect(() => {
    ...
    if (
      dataStored.fullname?.length == 0 ||
      dataStored.email.length == 0 ||
      ...
      setData({
        ...data,
        fullname: dataStored.fullname,
        businessname: dataStored.businessname,
        email: dataStored.email,
        number: dataStored.number,
      });
  ...
  return (
    <div className="flex flex-col mx-5 my-8 pt-8 pb-8 items-center bg-white rounded-lg shadow-md relative md:w-[55%]">
      <p
        className="fontTitle text-center"
        style={{ fontWeight: "700", color: "#4a6bb6" }}
      >
        {" "}
        <span className="colorPrimary">
          Congratulations on winning
        </span> <br />{" "}
        <span className="underline mt-1">{prize.description}</span> software
        subscription!!
      </p>

      <p className="fontSubTitle text-center" style={{ fontSize: "1.5rem" }}>
        To go with your free plastic referral marketing cards.
      </p>

      <p
        className="fontGeneral pb-0 mb-5"
      ...
      <p
        className="fontGeneral pb-1 underline"
        style={{
          fontWeight: "700",
          color: "#4a6bb6",
          fontSize: "1.5rem",
      ...
      >
        Use as many of the features as you like
      </p>

      <div
        id="DIVsoftwarecomponents"
        className="flex flex-col justify-center mt-5 items-center w-[90%] rounded-lg shadow-lg pb-2 mb-3 bg-[#0099CB]"
      >
        <p
          className="text-2xl font-bold py-4 text-white"
          style={{ paddingBottom: "0.2rem" }}
        >
          Software Components
        </p>
        <ul className="fontGeneral py-8">
          <li className=" flex justify-around items-center h-fit border-2 border-[#044CAB] py-1">
            <div className=" w-[95%] h-[100%] flex justify-center items-center">
              <p
                className="fontGeneral text-white"
                style={{ textAlign: "start", padding: "0 4px 0 2px" }}
              >
                1.-
              </p>
              <p
                className="fontGeneral text-white w-[100%]"
                style={{ textAlign: "start", padding: "0 0 0 0" }}
              >
                Database
              </p>
            </div>
            <span className="w-[2px] h-[30px] bg-[#044CAB]"></span>
            <div className="w-[95%] h-[100%] flex justify-center items-center">
              <p
                className="fontGeneral text-white"
                style={{ textAlign: "start", padding: "0 4px 0 2px" }}
          ...
          <li className=" flex justify-around items-center h-fit border-2 border-[#044CAB] py-1">
            <div className="w-[95%] h-[100%] flex justify-center items-center">
              ...
              <p
                className="fontGeneral text-white w-[100%] text-center"
                style={{ textAlign: "start", padding: "0 0 0 0" }}
              >
                Referral Marketing
              </p>
      ...
      <p
        className="fontGeneral pb-3"
        style={{ textAlign: "center", fontStyle: "italic" }}
      >
        After your FREE trial, ONLY pay for what features you want to use.{" "}
        <br />
      </p>

      <p
        className="fontGeneral pb-0 underline"
        style={{ fontWeight: "700", color: "#4a6bb6", fontSize: "1.5rem" }}
      >
      ...
      <div
        id="tables"
        className="flex mt-5 flex-col w-[95%] border-2 mb-5 md:w-[80%]"
      >
        <table className="w-[100%] border rounded-lg mb-0 ">
          <thead>
            <tr>
              <th
                className="resize-text py-1 px-0 w-[50%]"
                style={{ border: "none" }}
              >
                Package
              </th>
          ...
          <tbody>
            <tr className="border-b bg-neutral-200">
              <td className="resize-text py-1 px-0" style={{ border: "none" }}>
                Silver
              </td>
              <td className="resize-text py-1 px-0" style={{ border: "none" }}>
                Database + 1
        ...
        <table className="w-[100%] border rounded-lg mb-0">
          <thead>
            <tr>
              <th className="w-[4%]" style={{ border: "none" }}>
                {" "}
              </th>
              <th
                className="resize-text py-1 px-0 w-[32%]"
                style={{ border: "none" }}
              >
                Monthly
              </th>
      ...
      <div className=" text-center">
        <p
          className="fontAlternative"
          style={{ paddingBottom: "14px", fontSize: "1rem" }}
        >
      ...
      <div className="flex gap-4 justify-center items-center fontGeneral py-2 border-2 w-[95%] md:justify-around">
        <label
          className="text-red-700 text-[1rem]"
      ...
      <div className="bg-[#d15d4ea9] w-[95%] my-2">
        <p
          className="my-1 text-[1rem] text-center text-white"
      ...
      {period !== 0 && (
        <div>
          <p className="fontGeneral mt-3" style={{ textAlign: "center" }}>
            ...
            will be due on <br />
            <span style={{ fontSize: "1.2rem" }}>{prize.date}</span>
          </p>
